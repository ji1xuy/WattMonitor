...
/*
  ...
  v_20251011.00 SDカード内のファイルの内容を表示する機能を追加
*/
// **************************************************************************************************
...
void printFileNameList(
  ...
  for (int i = 0; i < 10; i++) {
    ...
    printFileName(j, X_LEFT, Y_TOP + i * 14);
  }
  // 現在ページ / 総ページ
  myGLCD.setColor(VGA_WHITE);
  ...
  printFileName(fileNum, X_LEFT, Y_TOP + row * 14);
}
...
void changeCursol(int currFileNum, int nextFileNum) {
  ...
  myGLCD.setBackColor(VGA_BLACK);
  printFileName(currFileNum, 8, 14 + currRow * 14);
  myGLCD.setColor(VGA_BLACK);
  myGLCD.setBackColor(getFileNameColor(nextFileNum));
  printFileName(nextFileNum, 8, 14 + nextRow * 14);
}
