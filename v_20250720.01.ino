#define VER "Program version 20250720.01"
//**************************************************************************************************
/*
  電力モニター Watt_Monitor
  ■主要部品
  ...
  v_20250720.01 getClockTime()関数 DS1302のtCWH:4μsを確保するためにdelayMicroseconds(4)を追加
*/
// **************************************************************************************************
      ...
      case UPDATE_SCREEN:
        switch (currScreenMode) {
          case SCREEN_ON:
            ...
            printBarGraph();            // 消費電力のバーグラフを表示            myGLCD.setFont(SmallFont);
            updateTarget++;
            break;
          case SCREEN_CLOCK:
            printClockDateTime();
