...
void printWindowFrame(int left, int top, int right, int bottom, unsigned int c = VGA_BLACK);
...
void printWindowFrame(int left, int top, int right, int bottom, unsigned int c) {
  myGLCD.setColor(c);
  myGLCD.fillRoundRect(left, top, right, bottom);
  myGLCD.setColor(VGA_WHITE);
  myGLCD.setBackColor(VGA_BLACK);
