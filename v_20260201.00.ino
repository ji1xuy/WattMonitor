#define VER "Program version 20260201.00"
//**************************************************************************************************
/*
  電力モニター Watt_Monitor
  ■主要部品
  ...
  v_20260201.00 時刻同期の情報の内容を変更((T mm/dd hh:mm nnnnhR → Time sync yy/mm/dd hh:mm [nnnnh]R) 
...
bool resetFlashAir(int sec = 10, bool isSystemResetEnabled = false);
...
bool resetFlashAir(int sec, bool isSystemResetEnabled) {
  if (existsFlashAir == false) {
    return false;
  }
  onOffFlashAir(sec);
