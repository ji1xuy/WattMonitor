#define VER "Program version 20231116"
//**************************************************************************************************
/*
  電力モニター Watt_Monitor
  ■主要部品
...
char syncTimeInfo[] = "--/-- --:-- ----h ";
// requestFlashAirReset()実行(FlashAIrリセット要求)時、syncTimeInfo[REQUEST_MARK]を'R'にセット
// resetFlashAir()実行(FlashAIrリセット処理)時、syncTimeInfo[REQUEST_MARK]を' 'にセット
const int REQUEST_MARK = 17;
