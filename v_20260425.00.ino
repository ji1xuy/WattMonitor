#define VER "Program version 20260425.00"
//**************************************************************************************************
/*
  電力モニター Watt_Monitor
  ■主要部品
...
void turnOnScreen(bool initLCD = true);
...
// ************************************************************************************
// 画面表示関連関数
void turnOnScreen(bool initLCD) {
...
bool isEnoughMemory(int requiredMmemory = 500) {
  if (getFreeMemory() < requiredMmemory) {
    noInterrupts();
    beep(BEEP_LOW);
    printFreeMemory(278, 0);
