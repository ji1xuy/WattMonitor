#define VER "Program version 20251129.00"
//**************************************************************************************************
/*
  電力モニター Watt_Monitor
  ■主要部品
...
void deleteFileNameList(void) {
  ...
  for (int i = 0; i <  numberOfFiles; i++) {
    free(fileNameList[i]->path);
    free(fileNameList[i]->name);
    free(fileNameList[i]->size);
